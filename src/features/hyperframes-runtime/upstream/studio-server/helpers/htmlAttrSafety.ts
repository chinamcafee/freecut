/**
 * Local mirror of the HyperFrames core HTML attribute safety helpers used by
 * sourceMutation. Kept here so Studio Server helpers do not import
 * @hyperframes/* packages at runtime.
 */
