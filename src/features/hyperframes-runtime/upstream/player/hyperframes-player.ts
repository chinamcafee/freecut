...
class HyperframesPlayer extends HTMLElement {
  ...
  private _runtimeSessionMetadata(): RuntimeSessionMetadata {
    return {
      projectId: this.dataset.projectId || undefined,
      compositionPath: this.dataset.compositionPath || undefined,
      nonce: this.dataset.sessionNonce || undefined,
      sandboxToken: this.dataset.sandboxToken || undefined,
    };
  }
  ...
  private _onMessage(e: MessageEvent) {
    handleRuntimeMessage(e, this.iframe.contentWindow, {
      ...
      projectId: this.dataset.projectId || undefined,
      compositionPath: this.dataset.compositionPath || undefined,
      sessionNonce: this.dataset.sessionNonce || undefined,
      sandboxToken: this.dataset.sandboxToken || undefined,
    });
  }
