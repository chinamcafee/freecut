import type { ResolvedSlideshow, ResolvedSlide } from "../../core/slideshow/index.js";
...
export class SlideshowController {
  ...
  private get frame(): StackFrame {
    ...
    if (!frame) throw new Error("Slideshow navigation stack is empty");
    return frame;
  }
