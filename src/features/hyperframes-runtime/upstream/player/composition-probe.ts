...
const FREECUT_DEFAULT_RUNTIME_URL = "/hyperframes-runtime/core/runtime.js";
...
export class CompositionProbe {
  ...
  private _resolveDirectTimelineAdapterFromWindow(win: Window): DirectTimelineAdapter | null {
    ...
    const key = rootId && rootId in timelines ? rootId : fallbackKey;
    if (!key) return null;
