    ...
    >
      {state.targetIsFolder && (
        <>
          ...
          >
            ...
            {t('hyperframes.studio.newFolder')}
          </button>
      ...
      {!state.targetIsFolder && (
        ...
        >
          ...
          {t('hyperframes.studio.duplicate')}
        </button>
      )}
      <div className="border-t border-neutral-700 my-1" />
      <button
  ...
  return (
    ...
    >
      ...
      <input
        ...
        onBlur={handleBlur}
        aria-label={t(isFolder ? 'hyperframes.studio.folderName' : 'hyperframes.studio.fileName')}
...
export function DeleteConfirm({
  ...
  return (
    ...
    >
      <p className="text-neutral-300 mb-2">{t('hyperframes.studio.deleteConfirm', { name })}</p>
