...
import { ModelCapabilityCenter } from '@/features/hyperframes-runtime/model-center/ModelCapabilityCenter'
...
export function SettingsDialog({ open, onOpenChange, initialSection = 'general' }: SettingsDialogProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-4xl gap-0 overflow-hidden p-0 sm:top-16 sm:max-h-[calc(100vh-4rem)] sm:translate-y-0 sm:origin-top">
        <DialogHeader className="flex flex-row items-center justify-between border-b px-6 py-4 pr-14">
          <div>
            <DialogTitle>{t('settings.title')}</DialogTitle>
            <DialogDescription className="sr-only">
              Configure editor, timeline, AI model, and storage settings.
            </DialogDescription>
          </div>
          <Button
            variant="ghost"
